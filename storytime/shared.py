...
def DATDictWriter(f, fieldnames, restval='', *args, **kwargs):
	_initCsvDATDialect()
	return csv.DictWriter(f, fieldnames, dialect='DAT', restval=restval, *args, **kwargs)

def DATDictReader(f, fieldnames=None, restkey=None, restval=None, *args, **kwargs):
	_initCsvDATDialect()
...
def DATReader(f, *args, **kwargs):
	_initCsvDATDialect()
	return csv.reader(f, dialect='DAT', *args, **kwargs)

def DATWriter(f, *args, **kwargs):
	_initCsvDATDialect()
